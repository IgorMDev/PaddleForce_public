...
[CustomEditor(typeof(MessageTrigger), true)]
public class MessageTriggerEditor : Editor{
    ...
    protected virtual void OnEnable()
    {
        ...
        m_IconToolbarMinus.tooltip = "Remove all messages in this list.";

        string[] eventNames = Enum.GetNames(typeof(MessageTriggerType));
